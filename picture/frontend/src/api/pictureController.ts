...
/** aiAutoTag POST /api/picture/auto_tag */
export async function aiAutoTagUsingPost(
  body: API.PictureAutoTagRequest,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponsePictureAutoTagResponse_>(
    "/api/picture/auto_tag",
    {
      method: "POST",
      headers: {
...
/** listPictureVOByPageWtihCache POST /api/picture/list/page/vo/cache */
export async function listPictureVoByPageWtihCacheUsingPost(
  body: API.PictureQueryRequest,
  options?: { [key: string]: any }
) {
...
export async function searchPictureByPictureIsSoUsingPost(
  ...
  return request<API.BaseResponseListSoImageSearchResult_>(
    "/api/picture/search/picture/so",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
...
export async function createText2ImageTaskUsingPost(
  body: API.CreateText2ImageRequest,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponseCreateOutPaintingTaskResponse_>(
    "/api/picture/text2image/create_task",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
...
/** getText2ImageTask GET /api/picture/text2image/get_task */
export async function getText2ImageTaskUsingGet(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.getText2ImageTaskUsingGETParams,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponseGetAiImageTaskResponse_>(
    "/api/picture/text2image/get_task",
    {
      method: "GET",
      params: {
        ...params,
...
/** uploadUrlPicture POST /api/picture/upload/url */
export async function uploadUrlPictureUsingPost(
