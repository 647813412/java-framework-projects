...
/** applyJoinSpace POST /api/spaceUser/apply */
export async function applyJoinSpaceUsingPost(
  body: API.SpaceUserApplyRequest,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponseLong_>("/api/spaceUser/apply", {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
    },
...
/** approveSpaceUser POST /api/spaceUser/approve */
export async function approveSpaceUserUsingPost(
  body: API.SpaceUserApproveRequest,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponseBoolean_>("/api/spaceUser/approve", {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
    },
