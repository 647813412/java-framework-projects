...
/** useRegister POST /api/user/register */
export async function useRegisterUsingPost(
...
/** searchUser POST /api/user/search */
...
/** updateUserVO POST /api/user/user/update */
export async function updateUserVoUsingPost(
  body: API.UserUpdateRequest,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponseBoolean_>("/api/user/user/update", {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
    },
